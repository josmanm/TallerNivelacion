...
const useSessionStorage = (key = '') => {
    ...
    const [storagedData, setStoragedData] = useState(() => JSON.parse(sessionStorage.getItem(key)))
    ...
    return { storagedData, getInfoInStorage, saveInfoInStorage, deleteInfoInStorage }
}
